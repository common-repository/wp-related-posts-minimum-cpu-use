<?php
/*
 * Plugin Name: Wp related posts with minimum CPU use
 * Plugin URI: http://ns99.info/uncategorized/wp-related-post-minimum-cpu-use.html
 * Description: A related posts plugin that works quickly even with thousands of posts and tags
 * Version: 1.3.0
 * Author: Furlan365
 * Author URI: http://ns99.info
 * Text Domain: Wp related posts – minimum CPU use
 */

  // proba

require_once('related-posts1.php');
class efficientRelatedPosts extends XavisysPlugin {
	...
	public function MetaBoxesfirst() {
